...
class kitsu_connect_panel(QtWidgets.QWidget):
    ...
    def build_media_tree(self):
        shot_folder = os.path.join(self.project_root, 'shot', self.sequence, self.shot, 'media' )
        print(shot_folder)
    ...
    def build_save_load(self):
        shot_folder = os.path.join(self.project_root, 'shot', self.sequence, self.shot, 'project_files' )
        if os.path.exists(shot_folder):
